...
| 工程环境与开发准入 | `NFR-ENV-001`、`NFR-ENV-002`、`NFR-DEV-001`、`AC-ENV-001`、`AC-DEV-001` | SchoolWork 远程 Supabase 数据源、受控浏览器操作、自动化例外、规范读取和变更准入 | T-102F、T-505C2、[`remote-supabase-workflow.md`](../../docs/sdd/remote-supabase-workflow.md)、`check-consistency.ps1`、`check:system-test-plan` |
