...
| 毕业设计 P0 演示验收 | 所有 P0 FR、`AC-AUTH-001`、`AC-SAMPLE-001～002`、`AC-TASK-001`、`AC-DATA-001`、`AC-REVIEW-001`、`AC-REPORT-001`、`AC-RESOURCE-001`、`AC-AUDIT-001`、`AC-DASH-001` | 合成数据目录、角色切换、环境前置检查和逐页演示证据；[`design-demo-scenario.md`](design-demo-scenario.md)、[`demo-runbook.md`](../../docs/demo/demo-runbook.md) | T-505、T-505C1、`REV-DEMO-001`、`check:demo-assets`、`test:demo-preflight`、隔离环境演练记录 |
