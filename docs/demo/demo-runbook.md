...
4. 按数据目录准备 `DEMO_LAB_01`、`DEMO_ZONE_01`、`DEMO_P_001`、`DEMO_M_001`、`DEMO_INST_001`、`DEMO_REAGENT_001`、`DEMO_T_001`、`DEMO_S_001` 和 `DEMO_RAW_001`。
5. 打开浏览器但不要预先登录多个账号；每次切换角色都先退出，避免把一个角色的会话误用于下一步。
