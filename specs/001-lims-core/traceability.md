...
| GB/T 40343—2021：设备管理 | `FR-EQUIP-001～006` | 仪器设备档案、维护/维修/校准、状态、负责人、提醒和数据关联；[`design-instrument-registry.md`](design-instrument-registry.md)、[`design-instrument-maintenance.md`](design-instrument-maintenance.md) | T-401、T-402、`AC-RESOURCE-001`、`REV-INSTRUMENT-REGISTRY-001`、`REV-INSTRUMENT-MAINTENANCE-001`、`test:instrument-integration`、`instrument-maintenance-validation.test.ts`、`instrument-access.spec.ts` |
| GB/T 40343—2021：试剂与耗材 | `FR-INVENTORY-001～004` | 试剂耗材主档、批号/厂家/有效期、库存余额和入库/领用/退库/报废变动；[`design-inventory-management.md`](design-inventory-management.md)、migration `202607160017` | T-403、`AC-RESOURCE-001`、`REV-INVENTORY-MANAGEMENT-001`、`test:inventory-integration`、`inventory-validation.test.ts`、`inventory-access.spec.ts` |
